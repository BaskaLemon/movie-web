...
export default function GenrePage() {
  ...
  return (
    <div className="container">
      <div className="justify-center w-screen dark:bg-black dark:text-white space-y-20">
        <Header />
        ...
        <div className="space-y-8 justify-center">
          <div className="flex h-fit w-full justify-center ">
            ...
            <div className="flex flex-col gap-5">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 ml-10">
                {loading ? (
