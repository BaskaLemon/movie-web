...
export default function MovieDetails() {
  ...
  return (
    <div className="flex flex-col items-center w-full dark:bg-black dark:text-white">
      <Header />
      ...
      <div className="w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          {movie.genres?.map((genre) => (
            <div
              key={genre.id}
              className="px-3 py-1 text-xs border border-gray-400 rounded-xl dark:border-gray-700"
            >
              {genre.name}
            </div>
          ))}
        ...
        <div className="mt-8 space-y-4 text-sm sm:text-base">
          <div className="flex flex-col sm:flex-row sm:gap-10 border-b pb-2 dark:border-gray-700">
